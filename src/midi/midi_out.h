...
namespace midi {
    void sendControls(uint8_t user_mode);
    ...
    bool sendControlConfigurations(uint8_t mode_index, uint8_t adjusted_mode);
    bool sendButtonConfiguration(uint8_t mode_index, uint8_t adjusted_mode, uint8_t control_index);
    bool sendLedConfiguration(uint8_t mode_index, uint8_t adjusted_mode, uint8_t control_index);
    bool sendDisplayConfigurations(uint8_t mode_index, uint8_t adjusted_mode);
