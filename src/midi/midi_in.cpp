...
// void midi::parseArrayItem(uint8_t itemType, char* strBuf, uint8_t listIndex, uint8_t listLength) {
  ...
  //     }
  //   //   if (oscDebug) {
  //   //     Serial.print("setlist: ");
  //   //     Serial.print(listIndex);
  //   //     Serial.print(" / ");
  //   //     Serial.print(listLength);
  //   //     Serial.print(" : ");
  //   //     Serial.println(_main.setlistsList[listIndex]);
  //   //   }
  //     menuPage.createMenu(SETLIST_MENU, 0);
  //     break;

  //   case Song_Array_Item:
  //     main. songsListSize = listLength;
  //     for (int i = 0; i < MAX_SONG_NAME; i++) {
  //       main.songsList[listIndex][i] = strBuf[i];
  //     }
  //   //   Serial.print("songs: ");
  //   //   Serial.println(main.songsList[listIndex]);
  //     menuPage.createMenu(SONG_MENU, _main.activeSongIndex);
  //     break;

  //   default:
  //     // Optionnel : Gérer les cas non prévus
  //   //   Serial.println("Unknown itemType");
  //     break;
  // }
// }
